...
/*
  ...
  const verificar = new controlVerificar(usuario)
        ...
        <div className="p-8">
          ...
          <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <Input id="usuario" name="usuario" type="text" required className="pl-10 block w-full" placeholder="juanito" />
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <Input id="email" name="email" type="text" required className="pl-10 block w-full" placeholder="juanito@ejemplo.com" />
            ...
            <div className="pt-3">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <InputC id="passwordR" name="password" type="password" required className="pl-10 block w-full" />
              </div>
            </div>
